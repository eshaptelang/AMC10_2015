...
# there were if we were given 84 sides and 25 shapes. For this problem, we need to import numpy because it is a python
# package for scientific computing. Of course there are other ways to solve simultaneous equations, but this is the easiest and
